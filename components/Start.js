...
const Start = ({ navigation }) => {
  ...
  useEffect(() => {
    async function loadFont() {
      await Font.loadAsync({
        ...
        "Poppins-Black": require("/Users/micahglausier/careerfoundry/Chat-Demo/fonts/Poppins/Poppins-Black.ttf"),
      });
      setFontLoaded(true);
    }
    loadFont();
  ...
  return (
    <View style={{ flex: 1 }}>
      <ImageBackground
        source={require("../imaages/bg-image.png")}
        style={styles.backgroundImage}
      >
        <KeyboardAvoidingView style={{ flex: 1 }}>
          <View style={styles.container}>
            <Text style={styles.title}>Welcome to ChatOn!</Text>
...
const styles = StyleSheet.create({
  ...
  title: {
    ...
    fontWeight: "600",
    color: "#FFFFFF",
    fontFamily: "Poppins-Black", // added this here if you want the title to use the font
    textAlign: "center"
  },
  chooseColorText: {
    fontSize: 16,
